...
for (int i = 0; i < e; i++) 
{ 
cout << "\nEnter the source vertex:- "; cin >> src; 
cout << "Enter the destination vertex:- "; cin >> des; 
if (src != des)
{ 
...
{ 
cout << "\nEdge already exists. Please select a new edge" << endl; i--; 
continue; 
} 
} 
else 
...
while (1) 
{ 
cout << "\nImplementation of Dijkstra's algorithm" << endl; cout << "1. Create graph" << endl; 
cout << "2. Display graph" << endl; 
cout << "3. Find shortest path using Dijkstra's algorithm" << endl; cout << "4. Exit the program" << endl; 
cout << "\nEnter your choice:- "; 
cin >> choice; 
switch (choice) 
{
case 1: 
cout << "\nEnter the number of vertices:- "; cin >> vertices; 
